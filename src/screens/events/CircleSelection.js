    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.circlesContainer}>
          <Image source={require('../../../../app/assets/pictures/photo5.png')} style={[styles.circle, styles.circle1]} />
          <Image source={require('../../../../app/assets/pictures/photo6.png')} style={[styles.circle, styles.circle2]} />
          <Image source={require('../../../../app/assets/pictures/photo7.png')} style={[styles.circle, styles.circle3]} />
        </View>
