...
type AvailabilityProps = NativeStackScreenProps<
  RootStackParamList,
  'AvailabilityFeature'
>;

const AvailabilityFeatureScreen: React.FC<AvailabilityProps> = ({ navigation }) => {
  return (
...
export default AvailabilityFeatureScreen;