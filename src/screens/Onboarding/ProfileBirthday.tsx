...
type ProfileBirthdayProps = NativeStackScreenProps<
  RootStackParamList,
  'ProfileBirthday'
>;

const ProfileBirthdayScreen: React.FC<ProfileBirthdayProps> = ({ navigation }) => {
...
export default ProfileBirthdayScreen;