...
type ProfilePreviewProps = NativeStackScreenProps<
  RootStackParamList,
  'ProfilePreview'
>;

const ProfilePreviewScreen: React.FC<ProfilePreviewProps> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.coverPhoto}>
        <Image source={{ uri: userData.bg }} style={styles.imageCoverPhoto} />
      </View>
